...
[![GoDoc](https://godoc.org/github.com/itech-eng/transition?status.svg)](https://godoc.org/github.com/itech-eng/transition)
...
```go
import "github.com/itech-eng/transition"
